...
export class SignInComponent implements OnInit {
  ...
  async loginSuccess(): Promise<void> {
    ...
    // example:
    // await this.router.navigate(['/projects/:projectId/diff?baselineId=XXX']) does not works
    // => should be this.router.navigate(['/projects/:projectId/diff'], { queryParams: { baselineId: 'XXX' } })
    await this.router.navigateByUrl(this.activatedRoute.snapshot.queryParams.returnUrl || '');
  }
